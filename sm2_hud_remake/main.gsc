...
init() {
    ...
    level.test = "background_image_blur_less";
    precacheshader(level.test);
...
hud_game_intro(start_time, time) {
    ...
    if(isdefined(level.info_mapname))
        level.info_mapname destroy();
...
create_weapon_ui() {
	...
	if(!isdefined(self.ui_elements["weapon_right_bg_light"])) {
	    ...
	    self.ui_elements["weapon_right_bg_light"].alpha = 1;
	    self.ui_elements["weapon_right_bg_light"].basealpha = 1;
        ...
        self.ui_elements["weapon_right_bg_light"].color = (.3, .3, .3);
	    self.ui_elements["weapon_right_bg_light"] setshader(level.test, 30, 30);
	...
	if(!isdefined(self.ui_elements["weapon_clip_count"])) {
	    ...
	    self.ui_elements["weapon_clip_count"].fontscale = 1;
	    self.ui_elements["weapon_clip_count"].color = (1, 1, 1);
	...
	if(!isdefined(self.ui_elements["weapon_stock_count"])) {
		...
		self.ui_elements["weapon_stock_count"].x = x - 76;
	    ...
	    self.ui_elements["weapon_stock_count"].fontscale = .6;
	    self.ui_elements["weapon_stock_count"].color = (.7, .7, .7);
	...
	if(!isdefined(self.ui_elements["weapon_grenade_bg"])) {
        ...
        self.ui_elements["weapon_grenade_bg"].color = (0, 0, 0);
	    self.ui_elements["weapon_grenade_bg"] setshader("white", 40, 20);
